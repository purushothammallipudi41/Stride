        ...
        <div className="maintenance-overlay">
            <div className="maintenance-content animate-pop-in">
                <div className="maintenance-icon-wrapper">
                    <Zap size={60} fill="var(--theme-primary, #8b5cf6)" color="white" />
                    <div className="maintenance-pulse" />
                </div>
                
                <h1 className="glitch-text" data-text="Syncing the Rhythm">Syncing the Rhythm</h1>
                <p>Stride is currently undergoing a planned frequency adjustment to improve your experience.</p>
                ...
                <div className="maintenance-footer">
                    ...
                    <div className="social-links">
                        <a href="https://twitter.com/thestrideapp" target="_blank" rel="noreferrer" className="social-tag">
